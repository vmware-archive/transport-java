...
@SpringBootTest(classes = {
        EventBusImpl.class,
        TransportSubscriptionService.class,
})
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD)
public class TransportSubscriptionServiceTest {

    @Autowired
    private EventBus bus;

    @Autowired
    private TransportSubscriptionService subscriptionService;
    ...
    public void testAddSubscriptionWithResponse() {
        ...
        TransportSubscriptionService.TransportSubscription sub =
        ...
        TransportSubscriptionService.NewBridgeSubscriptionEvent subscriptionEvent =
              (TransportSubscriptionService.NewBridgeSubscriptionEvent) this.monitorObject.getData();
        Assert.assertNotNull(subscriptionEvent);
        Assert.assertEquals(subscriptionEvent.transportSubscription.channelName, this.channel);
